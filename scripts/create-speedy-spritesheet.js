#!/usr/bin/env node
/**
 * Creates speedy spritesheet from extracted PixelLab animations.
 * Uses east-facing direction frames.
 * Output: public/assets/sprites/enemies/speedy.png
 */
...
const EXTRACTED_PATH = '/tmp/speedy_extract';
const OUTPUT_PATH = path.join(__dirname, '..', 'public/assets/sprites/enemies/speedy.png');
...
async function main() {
  console.log('Creating speedy spritesheet...');
