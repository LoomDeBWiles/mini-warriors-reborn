#!/usr/bin/env node
/**
 * Creates giant spritesheet from extracted PixelLab animations.
 * Uses east-facing direction frames.
 * Output: public/assets/sprites/enemies/giant.png
 */
...
const EXTRACTED_PATH = '/tmp/giant_extract';
const OUTPUT_PATH = path.join(__dirname, '..', 'public/assets/sprites/enemies/giant.png');
...
async function main() {
  console.log('Creating giant spritesheet...');
