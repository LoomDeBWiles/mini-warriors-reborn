#!/usr/bin/env node
/**
 * Creates brute spritesheet from extracted PixelLab animations.
 * Uses east-facing direction frames.
 * Output: public/assets/sprites/enemies/brute.png
 */
...
const EXTRACTED_PATH = '/tmp/brute_extract';
const OUTPUT_PATH = path.join(__dirname, '..', 'public/assets/sprites/enemies/brute.png');
...
async function main() {
  console.log('Creating brute spritesheet...');
